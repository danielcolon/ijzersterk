...
export default React.createClass({
    render(){
        return (<div className="col-md-8 col-md-offset-1">
            ...
            <p>You can join DSKV IJzersterk by filling out <a href="#">this Google form</a>. After that we will arrange a meeting with the current board. The board will like to get to know you better and to see where you are currently standing, what you goals are and what we expect from you and what you expect from us. Last step will then be to buy (obligated when joining IJzersterk) the t-shirt.</p>
            <p>With the t-shirt in hand and meeting with the board you will be able train together with us at the VKR and gain access to the Wiki and make use of the agenda system. Furthermore we also hold the Strongest Student competition each year which can be a great moment to test your strength when you join us!</p>
