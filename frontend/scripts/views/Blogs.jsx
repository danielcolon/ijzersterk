    ...
    render() {
        return (
          ...
          <div id="newsletter2" className="article">
            ...
            <div className="row">
              <img className="col-md-4" src="http://www.ijzersterkdelft.nl/images/150322/20150322-163628.jpg"/>
              <img className="col-md-4" src="http://www.ijzersterkdelft.nl/images/150322/20150322-163403.jpg"/>
              <img className="col-md-4" src="http://www.ijzersterkdelft.nl/images/150322/20150322-171822.jpg"/>
            </div>
            <div className="row">
              <div className="col-md-4 img-desc">
